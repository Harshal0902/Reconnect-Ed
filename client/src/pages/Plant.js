    ...
    return (
        <div className=''>
            <div className='grid place-items-center'>
                <h1 className='text-5xl text-white'>Plant Tree</h1>
            ...
            <div className="grid place-items-center">
                <div className="relative z-10 w-full max-w-lg my-20">
                    <div className="relative z-10 flex flex-col items-start justify-start p-10 bg-white shadow-2xl rounded-xl">
                        <h4 className="w-full text-4xl font-medium leading-snug">Plant Tree</h4>
                        <form className="relative w-full mt-6 space-y-8">
                            ...
                            <div className="relative">
                                ...
                                <input type="email" className="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="john@gmail.com" />
                            </div>
                            <div className="relative">
                                <label className="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Phone No.</label>
                                <input type="number" className="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="John Doe" />
                            </div>
                            <div className="relative">
                                <label className="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white">Donated on</label>
                                <input type="date" className="block w-full px-4 py-4 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" placeholder="365" />
                            </div>
                            <div className="relative">
